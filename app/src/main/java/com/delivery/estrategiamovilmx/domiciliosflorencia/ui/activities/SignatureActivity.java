...
import com.delivery.estrategiamovilmx.domiciliosflorencia.ui.fragments.PendingOrdersFragment;
...
public class SignatureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //gettting order item element location
        Intent i = getIntent();
        orderOnList = (int)i.getSerializableExtra(PendingOrdersFragment.ORDER_ELEMENT_ON_LIST);
    ...
    public class signature extends View {
        ...
        public void save(View v, String StoredPath) {
            ...
            try {
                ...
                Intent intent = new Intent();
                intent.putExtra(IMAGE_PATH, StoredPath);
                intent.putExtra(PendingOrdersFragment.ORDER_ELEMENT_ON_LIST, orderOnList);
