...
import com.delivery.estrategiamovilmx.domiciliosflorencia.ui.activities.MainClassificationsActivity;
...
public class BottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public static final String sheet_flow = "sheet_flow";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_manage_locations, container, false);//fragment_bottom_sheet
        //init elements
        ...
        RestServiceWrapper.getLocationsByUser(user != null ? user.getIdUser() : "0", type_query, new Callback<GetShippingAddressResponse>() {
            ...
            public void onResponse(Call<GetShippingAddressResponse> call, retrofit2.Response<GetShippingAddressResponse> response) {
                ...
                if (response != null && response.isSuccessful()) {
                    ...
                    /*Log.d(TAG,"Lista de direcciones..................");
                    for (ShippingAddress s:products_response.getResult()){
                        Log.d(TAG,"dir: "+s.toString());
                    }*/
            ...
            case PickupPointFragment.NEW_ADDRESS:
                if (resultCode == Activity.RESULT_OK) {//NEW_SHIPPING_ADDRESS
                    ...
                    if (update_address.equals(String.valueOf(true))){//edited address:: update on db
                        ...
                        assignAddressSelected(position,false);
                    }
    ...
    public void assignAddressSelected(int position, boolean closeSheet){
        updateAddressSelected(position,closeSheet,getActivity());
    }


    public void updateAddressSelected(final int position,final boolean closeSheet,final Activity act){//save shippingaddress selected on db
        initProcess(true);

        ShippingAddress item = locations.get(position);
        UserItem user = GeneralFunctions.getCurrentUser(getActivity());
        UpdateLocationRequest request = new UpdateLocationRequest();
        request.setAddress(item);
        request.setOperation(ManageLocationsActivity.ASSIGN_ADDRESS_OPERATION);
                ...
                if (response != null && response.isSuccessful()) {
                    ...
                    if (products_response != null && products_response.getStatus().equals(Constants.success)) {
                        ...
                        if (act instanceof MainActivity) {
                            ...
                            if (closeSheet) dismiss();
                        }else if(act instanceof MainClassificationsActivity){
                            MainClassificationsActivity clasif = (MainClassificationsActivity) act;
                            clasif.assignAddressSelected(locations.get(position));
                            if (closeSheet) dismiss();
                        }
    ...
    public void deleteShippingAddress(final int position){
        //Log.d(TAG,"deleteShippingAddress................................................POSICION:"+position);
        //show loading
        initProcess(true);
   ...
   /* @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        return new Dialog(getActivity(), getTheme()){
            @Override
            public void onBackPressed() {//validar el flujo actual para determinar la accion
                ShowConfirmations.showConfirmationMessage("aqui regresa....",getActivity());
            }
        };
    }*/
}
